 ...
 * @author mmh
 */
public class GeneralSubAccount2 extends javax.swing.JInternalFrame {

    /**
     * Creates new form GeneralSubAccount2
     */
    private DefaultTableModel dtm;

    public GeneralSubAccount2() {
        initComponents();
        initializeResources();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("උප ශිර්ෂ ලේජර සම්බන්ධතා");
        ...
        Table.setForeground(new java.awt.Color(3, 130, 42));
        ...
        txtMainAccNo.setForeground(new java.awt.Color(139, 0, 139));
        ...
        txtDescriptionSin.setForeground(new java.awt.Color(139, 0, 139));
        ...
        txtDescriptionEng.setForeground(new java.awt.Color(139, 0, 139));
        ...
        txtNo1.setMinimumSize(new java.awt.Dimension(271, 27));
        txtNo1.setPreferredSize(new java.awt.Dimension(271, 27));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(cmb_Acc_Level_2, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(358, 358, 358))
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(txtMainAccNo, javax.swing.GroupLayout.PREFERRED_SIZE, 271, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jLabel5, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtNoteNo))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(txtNo1, javax.swing.GroupLayout.PREFERRED_SIZE, 271, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(txtMainAccNo, javax.swing.GroupLayout.DEFAULT_SIZE, 27, Short.MAX_VALUE)
    ...
    private void btnNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewActionPerformed
        List<Object> outputs = SaveSubAccounts.saveSubAccount(3, "0", levels.getAcctLevelID2(), "", "", "", 0, 0, 0, 2);
...
//        jLabel10.setText(outputs.get(0).toString());
        levels.setAcctLevelID3(outputs.get(0).toString());
        btnNew.setEnabled(false);
        btnSave.setEnabled(true);
    }//GEN-LAST:event_btnNewActionPerformed

    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        List<Object> outputs = SaveSubAccounts.saveSubAccount(3, levels.getAcctLevelID3(), levels.getAcctLevelID2(), txtMainAccNo.getText(), txtDescriptionSin.getText(), txtDescriptionEng.getText(), Double.parseDouble(txtNo2.getText()), Double.parseDouble(txtNo1.getText()), Double.parseDouble(txtNoteNo.getText()), 2);
        txtDescriptionEng.setText("");
        txtDescriptionSin.setText("");
        txtMainAccNo.setText("");
        txtNo1.setText("0.00");
    ...
    private void TableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableMouseClicked
        if (Table.getSelectedRow() > -1) {
            ...
            btnSave.setEnabled(true);
            levels.setAcctLevelID3(Table.getValueAt(Table.getSelectedRow(), 0).toString());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GeneralSubAccount2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GeneralSubAccount2().setVisible(true);
            }
        });
    }
    ...
    private void loadDataTCcmbMainAccLevel() {
        try {
            ...
            Logger.getLogger(GeneralSubAccount2.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initializeResources() {
        jLabel3.setText(textBundle.getTextBundle().getString("subHeaderGL"));
