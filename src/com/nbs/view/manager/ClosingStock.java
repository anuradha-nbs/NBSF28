 ...
 * @author mmh
 */
public class ClosingStock extends javax.swing.JDialog {
     ...
     */
    public ClosingStock(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        changeTableHeader();
...
private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ClosingStock dialog = new ClosingStock(new javax.swing.JFrame(), true);
