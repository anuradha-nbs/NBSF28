 ...
 * @author mmh
 */
public class TargetStockOld extends javax.swing.JDialog {
     ...
     */
    public TargetStockOld(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        changeTableHeader();
        ...
        viewDT(cmbFinancialYear.getSelectedItem().getId(), cmbReportName.getSelectedItem().getId(), txtSubSectionHeader.getId());
    }
    ...
    private void initComponents() {
        ...
        cmbReportName = new org.nbs.components.HiddenItemComboBox();
        ...
        txtSubSection.setFont(new java.awt.Font("Iskoola Pota", 0, 18)); // NOI18N
        ...
        cmbReportName.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbReportNameActionPerformed(evt);
            }
        });

        jLabel3.setFont(new java.awt.Font("Iskoola Pota", 0, 18)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel3.setText("වාර්තාව :");
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cmbReportName, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap())
        );
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(cmbReportName, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//        new FindSectionOrOutsider(this, true, TableHeaders.SUBSECTIONFINDER_TABLE_MODEL, TableHeaders.SUBSECTIONFINDER_TABLE_MODEL2, 34, "අංශය").setVisible(true);
    ...
    private void cmbReportNameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbReportNameActionPerformed
        insertFields(cmbReportName.getSelectedItem().getId(),cmbFinancialYear.getSelectedItem().getId(),txtSubSectionHeader.getId());
        viewDT(cmbFinancialYear.getSelectedItem().getId(), cmbReportName.getSelectedItem().getId(),txtSubSectionHeader.getId());
    }//GEN-LAST:event_cmbReportNameActionPerformed
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new FindSectionOrOutsider(this, true, TableHeaders.SUBSECTIONFINDER_TABLE_MODEL, TableHeaders.SUBSECTIONFINDER_TABLE_MODEL2, 53, "අනු අංශය").setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TargetStockOld.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                TargetStockOld dialog = new TargetStockOld(new javax.swing.JFrame(), true);
    ...
    private org.nbs.components.HiddenItemComboBox cmbReportName;
...
//        }
    ...
    private void loadFinancialYear() {
        try {
            ...
            Logger.getLogger(TargetStockOld.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(TargetStockOld.class.getName()).log(Level.SEVERE, null, ex);
...
//            }
    ...
    private void viewDT(int id, int id2, int id3) {
        try {
            dtm.setRowCount(0);
            List<Object> inputs = new ArrayList<>();
            inputs.add(id);
            inputs.add(id2);
            inputs.add(id3);
            List<List<Object>> outputs = ServerConnection.getServerConnector().searchMultipleResults(inputs, "ssp_F28_LoadCombo_ViewTarget", 15);
            for (List<Object> output : outputs) {
                Vector v = new Vector();
    ...
    private void loadReportName() {
        try {
            ...
            cmbReportName.setModel(new DefaultComboBoxModel<>(v));
        } catch (SQLException ex) {
            Logger.getLogger(TargetStockOld.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(TargetStockOld.class.getName()).log(Level.SEVERE, null, ex);
