 ...
 * @author mmh
 */
public class StockTargets extends javax.swing.JDialog {
     ...
     */
    public StockTargets(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        changeTableHeader();
        ...
        viewDT(cmbFinancialYear.getSelectedItem().getId());
    }
    ...
    private void initComponents() {
        ...
        optPurchasePrice = new javax.swing.JRadioButton();
        optSellingPrice = new javax.swing.JRadioButton();
        ...
        txtSubSection.setMaximumSize(new java.awt.Dimension(329, 28));
        txtSubSection.setMinimumSize(new java.awt.Dimension(329, 28));
        txtSubSection.setPreferredSize(new java.awt.Dimension(329, 28));
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addComponent(txtSubSection, javax.swing.GroupLayout.PREFERRED_SIZE, 329, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
        ...
        buttonGroup1.add(optPurchasePrice);
        optPurchasePrice.setFont(new java.awt.Font("Iskoola Pota", 0, 18)); // NOI18N
        optPurchasePrice.setSelected(true);
        optPurchasePrice.setText("ගැණුම් මිලට");
        optPurchasePrice.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                optPurchasePriceActionPerformed(evt);
            }
        });

        buttonGroup1.add(optSellingPrice);
        optSellingPrice.setFont(new java.awt.Font("Iskoola Pota", 0, 18)); // NOI18N
        optSellingPrice.setText("විකුණුම් මිලට");
        optSellingPrice.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                optSellingPriceActionPerformed(evt);
            }
        });
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(optPurchasePrice)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(optSellingPrice)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(cmbFinancialYear, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(optPurchasePrice, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(optSellingPrice, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
...
private void dataTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dataTableMouseClicked
    if (dataTable.getSelectedRow() > -1) {
        ...
        JTextField fields[] = {txtSubSection, month1, month2, month3, month4, month5, month6, month7, month8, month9, month10, month11, month12};
        for (int i = 0; i < dataTable.getColumnCount(); i++) {
            switch (i) {
                ...
                case 12:
                    ...
                    break;
                case 13:
                    txtSubSection.setId(Integer.parseInt(String.valueOf(dataTable.getValueAt(selectedRow, 13))));
                    break;
                case 14:
...
private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
    ...
    private void txtSubSectionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtSubSectionActionPerformed
        new FindSectionOrOutsider(this, true, TableHeaders.SUBSECTIONFINDER_TABLE_MODEL, TableHeaders.SUBSECTIONFINDER_TABLE_MODEL2, 34, "අංශය").setVisible(true);
    ...
    private void optPurchasePriceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_optPurchasePriceActionPerformed
        if (optPurchasePrice.isSelected()) {
            viewDT(cmbFinancialYear.getSelectedItem().getId());
        }
    }//GEN-LAST:event_optPurchasePriceActionPerformed

    private void optSellingPriceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_optSellingPriceActionPerformed
        if (optSellingPrice.isSelected()) {
            viewDT(cmbFinancialYear.getSelectedItem().getId());
        }
    }//GEN-LAST:event_optSellingPriceActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StockTargets.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                StockTargets dialog = new StockTargets(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JRadioButton optPurchasePrice;
    private javax.swing.JRadioButton optSellingPrice;
...
//        }
    ...
    private void loadFinancialYear() {
        try {
            ...
            Logger.getLogger(StockTargets.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(StockTargets.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void saveClosingStock() {
        try {
            ...
            ServerConnection.getServerConnector().insertData(inputs, "ssp_F28_Insert_ClosingStock", 0);
        } catch (SQLException ex) {
            Logger.getLogger(StockTargets.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(StockTargets.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void viewDT(int id) {
        try {
            ...
            List<List<Object>> outputs = ServerConnection.getServerConnector().searchMultipleResults(inputs, "ssp_F28_LoadCombo_ClosingStock", 15);
            for (List<Object> output : outputs) {
                Vector v = new Vector();
