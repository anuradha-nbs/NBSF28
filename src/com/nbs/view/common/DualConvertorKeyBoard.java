 ...
 * @author mmh
 */
public class DualConvertorKeyBoard extends javax.swing.JPanel {
    ...
    /**
     * Creates new form DualConvertorKeyBoard1
     */
    private DualConvertorKeyBoard() {
        initComponents();
        ...
        specialConsonants[1] = "\\h";
        specialConsonantsUni[2] = "ඞ";
        specialConsonants[2] = "\\N";
        specialConsonantsUni[3] = "ඍ";
        specialConsonants[3] = "\\R";
        //special characher Repaya
        specialConsonantsUni[4] = "ර්" + "\u200D";
        specialConsonants[4] = "\\R";
        specialConsonantsUni[5] = "ර්" + "\u200D";
        specialConsonants[5] = "\\r";
    ...
    public DualConvertorKeyBoard(JTextComponent amaliTextComponent, JTextComponent unicodeTextComponent,boolean isAmaliOnly) {
        this();
    ...
    private void initComponents() {
        ...
        txtUni.setRows(5);
        txtUni.setComponentPopupMenu(jPopupMenu1);
        ...
        txtAma.setComponentPopupMenu(jPopupMenu2);
    ...
    private void selectedCopy1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectedCopy1ActionPerformed
        String selectedText = txtAma.getSelectedText();
        copy(selectedText);
